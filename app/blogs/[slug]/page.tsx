...
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const jsonLd = {
        ...
        '@type': 'BlogPosting',
        headline: post.title,
        description: post.content.find(block => block.type === 'paragraph')?.text?.slice(0, 160) + '...' || post.title,
        ...
        author: [{
            ...
            url: `${process.env.NEXT_PUBLIC_SITE_URL}/about` // Optional: Link to author page
        }],
        publisher: {
            '@type': 'Organization',
            name: 'Ramu Blogs',
